...
public class RecentCampaignModel {
    ...
    private String userName, userProfilePic, city, country, likeCount, shareCount, commentCount;
    ...
    public RecentCampaignModel(int campaignId, String userName, String userProfilePic, int userType, String likeCount,
                               ...
                               int currentAmount, int targetAmount, String photoLink) {
