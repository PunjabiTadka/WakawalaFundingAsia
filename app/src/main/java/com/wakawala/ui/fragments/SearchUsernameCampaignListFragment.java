 ...
 * Use the {@link SearchUsernameCampaignListFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SearchUsernameCampaignListFragment extends BaseFragment implements RecyclerItemClickInterface<Object> {
    ...
    public SearchUsernameCampaignListFragment() {
     ...
     */
    public static SearchUsernameCampaignListFragment newInstance() {
        SearchUsernameCampaignListFragment fragment = new SearchUsernameCampaignListFragment();
        return fragment;
    }
    ...
    protected void loadData() {
        String url = "search/searchuser?";
        String id = "partialname";
        String bookmark = "skip";
                    ...
                    public void onResponse(Call<Object> call, Response<Object> response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArrayResult.length(); i++) {
                                JSONObject jsonData = jsonArrayResult.getJSONObject(i);

                                SearchCampaignModel searchCampaignModel = new SearchCampaignModel(
                                        jsonData.getString(WebFields.USER__NAME),
                                        jsonData.getString(WebFields.PROFILEPIC),
                                        jsonData.getString(WebFields.EMAIL.toLowerCase()), ""
                                );
